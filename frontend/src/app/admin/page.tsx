      ...
      <div className="w-full max-w-md">
        <div className="glass-card water-drop glass-shine p-8">
          ...
          <div className="flex justify-center mb-8">
            <Image
              src="/logo-fontedvida.png"
              alt="Fonte D'Vida Logo"
              width={150}
              height={60}
              priority
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 glass-card text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition-all"
                placeholder="admin@fontedvida.com.br"
                disabled={isLoading}
              />
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-blue-300 text-xs">
              © 2025 Fonte D'Vida - Riscos Psicossociais
            </p>
          </div>
        </div>
